...
namespace COP.API.DatabaseInterface
{
    public class DBZone
    {
            ...
            try
            {
                using (COPDBContext.monica_cnetContext context = new COPDBContext.monica_cnetContext())
                {
                    ...
                    var loc = context.Location
                            .SingleOrDefault(b => b.Locationid == long.Parse(zonid));
        ...
        public bool ListZones(string zoneType, bool publicZone, ref string errorMessage, ref List<COP.API.Models.Zone> results)
        {
            bool retVal = true;
            try
            {
                    ...
                    if (locations == null)
                    {
                        ...
                        foreach (var loc in locations)
                        {
                            ...
                            try
                            {
                                ...
                                .SingleOrDefault(b => b.Locationid == loc.id);
                                if(things !=null)
                                {
                            ...
                            COP.API.Models.Zone z = new Models.Zone();
                            z.Name = loc.name;
                            z.Id = (int) loc.id;
        ...
        public bool ListPublicZones(string zoneType, bool publicZone, ref string errorMessage, ref List<COP.API.Models.Zone> results)
        {
            bool retVal = true;
            try
            {
                using (COPDBContext.monica_cnetContext context = new COPDBContext.monica_cnetContext())
                {
                    ...
                    var locations = (from d in context.Location
                                     join f in context.LocationTemplates
                                     on d.Locationtemplateid equals f.Locationtemplateid
                                     where f.Name == zoneType && f.PublicAccess
                                     select new
                                     { id = d.Locationid, name = d.Name, descripton = d.Description, metadata = d.Metadata, bpol = d.Boundingpolygon, capacity = d.Capacity, type = f.Name }
                                     ).ToList();
        ...
        public bool ListAllZones(bool publicZones, ref string errorMessage, ref List<COP.API.Models.Zone> results)
        {
            bool retVal = true;
            try
            {
        ...
        public bool ListAllPublicZones(bool publicZones, ref string errorMessage, ref List<COP.API.Models.Zone> results)
        {
            bool retVal = true;
            try
            {
        ...
        public bool FindZoneFromId(string zoneId, ref string errorMessage, ref COP.API.Models.Zone results)
        {
            bool retVal = true;
            try
            {
